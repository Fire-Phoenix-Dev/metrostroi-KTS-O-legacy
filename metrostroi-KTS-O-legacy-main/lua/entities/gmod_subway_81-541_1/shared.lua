...
ENT.Model = "models/metrostroi_train/81-5401/5411_ext1.mdl"
...
function ENT:InitializeSounds()
    ...
    self.SoundPositions["valve_door2"] = {80,1e9,Vector(285,-62,-20),1}
    self.SoundNames["valve_door3"] = {loop=true,"subway_trains/common/pneumatic/epv_loop.wav"}
    self.SoundPositions["valve_door3"] = {80,1e9,Vector(285,62,-20),1}
...
function ENT:InitializeSystems()
    ...
    self.Pneumatic.DisconnectType = true
    -- Everything else
