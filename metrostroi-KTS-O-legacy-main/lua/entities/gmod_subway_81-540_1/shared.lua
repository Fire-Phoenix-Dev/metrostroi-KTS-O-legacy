...
ENT.Model = "models/metrostroi_train/81-5401/5401_ext1.mdl"
...
local pult = Vector(18.1,6.6,-2.47)
ENT.Cameras = {
    {Vector(407.5+25,-40,22),Angle(0,180,0),"Train.717.Breakers"},
    {Vector(407.5+20,-40.5,3),Angle(0,180,0),"Train.717.VB"},
    {Vector(407.5+15,-60,14),Angle(0,180,0),"Train.717.SOSD"},
    {Vector(407.5+13,-40,-15),Angle(40,270,0),"Train.Common.UAVA"},
    {Vector(407.5+20,-10,-10),Angle(40,-40,0),"Train.Common.PneumoPanels"},
    {Vector(407.5+50,40,-15),Angle(0,90-30,0),"Train.Common.HelpersPanel"},
    {Vector(407.5+26,20,0)+pult,Angle(30,0,0),"Train.717.PA","PAM"},
    {Vector(407.5+30,18.5,-1)+pult,Angle(30,0,0),"Train.717.PAScreen","PAMScreen"},
    {Vector(427.5+70,42,-8),Angle(20,180,0),"Train.Common.RouteNumber"},
    {Vector(470+7,0,30),Angle(60,0,0),"Train.Common.CouplerCamera"},
}
function ENT:InitializeSounds()
    ...
    self.SoundPositions["parking_brake"] = {80,1e9,Vector(440,-52,-36),0.6}
    ...
    self.SoundNames["valve_door1"] = {loop=true,"subway_trains/common/pneumatic/epv_loop.wav"}
    self.SoundPositions["valve_door1"] = {80,1e9,Vector(50,-62,-20),1}
    self.SoundNames["valve_door2"] = {loop=true,"subway_trains/common/pneumatic/epv_loop.wav"}
    self.SoundPositions["valve_door2"] = {80,1e9,Vector(-297,-62,-20),1}
    self.SoundNames["valve_door3"] = {loop=true,"subway_trains/common/pneumatic/epv_loop.wav"}
    self.SoundPositions["valve_door3"] = {80,1e9,Vector(-297,62,-20),1}
...
--[[     self.SoundNames["kv70_0_t1"] = "subway_trains/717/kv70_4/kv70_0_t1.mp3"
    ...
    self.SoundPositions["ECRS"] = {60,1e3,Vector(468,-25,12),2}    
    ...
    for i=1,7 do
        self.SoundNames["vent"..i] = {loop=true,"subway_trains/717/vent/vent_cab_high.wav"}
        self.SoundPositions["vent"..i] = {100,1e9,Vector(-353+(i-1)*115.4,0,40)}
    end
...
function ENT:InitializeSystems()
    ...
    self:LoadSystem("Electric","81_540_1_Electric")

	self:LoadSystem("Ticker","81_540_1_Ticker")

	self:LoadSystem("ECRS","81_540_1_ECRS")

	self:LoadSystem("KTS_O","81_540_1_KTS_O")

	self:LoadSystem("RVS","81_540_1_RVS_1")
    ...
    self:LoadSystem("Pneumatic","81_540_1_Pneumatic")
    self.Pneumatic.ValveType = 2
    -- Панель управления 81-710
    self:LoadSystem("Panel","81_540_1_Panel")
    -- Everything else
...
ENT.NumberRanges = {{10222,10322}}

ENT.Spawner = {
    model = {
        "models/metrostroi_train/81-5401/5401_ext1.mdl",
        "models/metrostroi_train/81-5401/5401_ext2.mdl",
        "models/metrostroi_train/81-5401/5401_underwagon1.mdl",
        "models/metrostroi_train/81-5401/5401_underwagon2.mdl",
        "models/metrostroi_train/81-5401/5401_int1.mdl",
        "models/metrostroi_train/81-5401/5401_int2.mdl",
        "models/metrostroi_train/81-5401/5401_cab1.mdl",
        "models/metrostroi_train/81-5401/5401_cab2.mdl",
        "models/metrostroi_train/81-5401/5401_int_cover3.mdl",
        "models/metrostroi_train/81-5401/5401_int_cover4.mdl",
        {"models/metrostroi_train/81-717/pult/body_spb_yellow.mdl",pos=Vector(18.1,6.6,-2.47)},
    },
    interim = "gmod_subway_81-541_1",
    ...
    {"Type","Spawner.717.Type","List",{"Spawner.717.Type.Line2"}},
    ...
    {"SpawnMode","Spawner.717.SpawnMode","List",{"Spawner.717.SpawnMode.Full","Spawner.717.SpawnMode.Deadlock","Spawner.717.SpawnMode.NightDeadlock","Spawner.717.SpawnMode.Depot"}, nil,function(ent,val,rot,i,wagnum,rclk)
        ...
        if val==4 then ent.Pneumatic.TrainLinePressure = 5.2 end
        ent.Pneumatic.DoorLineLeftPressure = ent.Pneumatic.TrainLinePressure
        ent.Pneumatic.DoorLineRightPressure = ent.Pneumatic.TrainLinePressure
        ent.Pneumatic.PrevDoorLineLeftPressure = ent.Pneumatic.TrainLinePressure
        ent.Pneumatic.PrevDoorLineRightPressure = ent.Pneumatic.TrainLinePressure
        if ent.DoorCrane1 then
            ent.Pneumatic.Door2Pressure = ent.Pneumatic.TrainLinePressure
            ent.Pneumatic.PrevDoor2Pressure = ent.Pneumatic.TrainLinePressure
        end
    end},
}