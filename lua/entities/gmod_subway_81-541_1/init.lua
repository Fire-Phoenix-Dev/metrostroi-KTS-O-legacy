...
function ENT:Initialize()
    ...
    self:SetModel("models/metrostroi_train/81-5401/5411_ext1.mdl")--"models/metrostroi_train/81-717/81-717_spb_int.mdl")
...
function ENT:OnButtonPress(button,ply)
    ...
    if not self.CouchCap and (not button:find("VB") and not button:find("AirDistributor") and not button:find("GV") and not button:find("Doors") and not button:find("Crane") and not button:find("Isolation") and not button:find("Parking")) then return true end
