...
ENT.ClientProps["begstroka_tabloR"] = {
	...
	pos = Vector(435.60,0,60), --449.30,0,55
	ang = Angle(0,0,0),
	scale=1,
	hide=2,
}
ENT.ButtonMap["begstrokaR"] = {
    pos = Vector(434.72,26.5,61.6),
    ang = Angle(0,-90,90),
    width = 694,
    height = 45,
    scale = 0.074,
...
ENT.ClientProps["begstroka_tabloF"] = {
    model = "models/metrostroi_train/81-5402/dev4you_begstroka.mdl",
	pos = Vector(-448.60,0,66), --435.60,0,60
	ang = Angle(0,180,0),
	scale=1,
	hide=2,
}
ENT.ButtonMap["begstrokaF"] = {
    pos = Vector(-447.72,-26.5,67.65),
    ang = Angle(0,90,90),
    width = 694,
    height = 45,
    scale = 0.074,
...
for i = 0,10 do
    ENT.ClientProps["salon_vent_r_"..i] = {
        model = "models/metrostroi_train/81-5402/ventilation.mdl",
        pos = Vector(394-74.35*i,32,70.2),
        ang = Angle(0,0,0),
...
ENT.ClientProps["salon_vent_r_11"] = {
        model = "models/metrostroi_train/81-5402/ventilation.mdl",
        pos = Vector(401.75-74.35*11,32,70.2),
        ang = Angle(0,0,0),
		bscale = Vector(1,0.8,1),
        color = Color(255,255,255),
        hide = 1.5,
    }
for i = 0,10 do
    ENT.ClientProps["salon_vent_l_"..i] = {
        model = "models/metrostroi_train/81-5402/ventilation.mdl",
        pos = Vector(394-74.35*i,-32,70.2),
        ang = Angle(0,180,0),
		bscale = Vector(1,1.012,1),
...
ENT.ClientProps["salon_vent_l_11"] = {
        model = "models/metrostroi_train/81-5402/ventilation.mdl",
        pos = Vector(401.75-74.35*11,-32,70.2),
        ang = Angle(0,180,0),
		bscale = Vector(1,0.8,1),
...
function ENT:DrawPost(special)
    ...
    self:DrawOnPanel("begstrokaR",function(...)
        ...
        surface.DrawTexturedRectRotated(417.5,30,748+64,57,0)
    end)
	self.RTMaterial:SetTexture("$basetexture", self.Tickers)
