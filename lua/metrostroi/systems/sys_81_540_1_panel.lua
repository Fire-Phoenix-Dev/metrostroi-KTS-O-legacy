Metrostroi.DefineSystem("81_540_1_Panel")
...
function TRAIN_SYSTEM:Initialize()
    ...
    self.Train:LoadSystem("DoorCrane1","Relay","Switch")
    ...
    self.Train:LoadSystem("P_11","Relay","Switch",{bass = true,normally_closed = true })
    self.Train:LoadSystem("P_11K","Relay","Switch",{bass = true,normally_closed = true })
    self.Train:LoadSystem("P_1","Relay","Switch",{bass = true,normally_closed = true })
    self.Train:LoadSystem("P_1K","Relay","Switch",{bass = true,normally_closed = true })
    self.Train:LoadSystem("P_5","Relay","Switch",{bass = true,normally_closed = true })
    self.Train:LoadSystem("P_5K","Relay","Switch",{bass = true,normally_closed = true })
    self.Train:LoadSystem("P_6","Relay","Switch",{bass = true,normally_closed = true })
    self.Train:LoadSystem("P_6K","Relay","Switch",{bass = true,normally_closed = true })
    self.Train:LoadSystem("P_29","Relay","Switch",{bass = true,normally_closed = true })
    self.Train:LoadSystem("P_29K","Relay","Switch",{bass = true,normally_closed = true })
